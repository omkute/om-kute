  ...
  return (
    ...
    <div className='pb-9'>
      <div className='text-center shadow-xl rounded-xl py-4'>
        ...
        <p className="py-2 sm: px-4">Creating Eligant designs suited for your 
        needs following core desing theory</p>
        <h4 className='py-4 text-cyan-600 sm: px-4' >Programming Language's I use</h4>
